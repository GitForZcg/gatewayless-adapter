 ...
 */
@Data
public class OrderPreviewParam {
     ...
     */
    private List<DiyGiftCouponPayParam> diy_gift_coupon_pay;
     ...
     * 员工信息
     */
    private List<EmployeeParam> employees;
     ...
     * 使用的折扣券
     */
    private List<DiscountCouponParam> discount_coupons_ids;
