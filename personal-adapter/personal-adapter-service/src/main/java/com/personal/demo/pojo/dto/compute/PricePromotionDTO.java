 ...
 */
@Data
public class PricePromotionDTO implements DemoComputeMd5Param, Serializable {
     ...
     * 查看菜品列表
     */
    private List<ViewDishesItemDTO> viewDishesList;
     ...
     * 执行信息
     */
    private ExecuteInfoDTO executeInfo;
     ...
     * 批次汇总列表
     */
    private List<BatchSummaryItemDTO> batchSummaryList;

    /**
     * 优惠券订阅列表
     */
    private List<CouponDishInfoDTO> couponSubscribeList;

    /**
     * 代金券订阅列表
     */
    private List<CouponCashInfoDTO> vouchersSubscribeList;
