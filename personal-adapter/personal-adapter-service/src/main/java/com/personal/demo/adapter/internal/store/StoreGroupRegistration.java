 ...
 */
@Component
public class StoreGroupRegistration extends AbstractValidationGroupRegistry<StoreNode> {

    public StoreGroupRegistration() {
        super(StoreNode.class, ValidationGroups.storeGroup.class);
    }
