 ...
 */
@Component
public class ComputeGroupRegistration extends AbstractValidationGroupRegistry<ComputeNode> {

    public ComputeGroupRegistration() {
        super(ComputeNode.class, ValidationGroups.computeGroup.class);
    }
}
